...
3) account_db.sql 파일을 아래 명령으로 import:
   mysql -u root -p account_db < account_db.sql

✅ 이제 account_db 데이터베이스에 테이블과 데이터가 세팅됩니다.
...
계정은 account_db.sql에 포함된 초기 데이터에 존재합니다.
